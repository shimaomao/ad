package com.planx.pay.system.config;
...
import com.planx.pay.response.RestResponseBody;
import com.planx.pay.response.RestStatus;
import com.planx.pay.system.exception.ApplicationException;

@RestControllerAdvice(basePackages="com.planx.pay.controller")
